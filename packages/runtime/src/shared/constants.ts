...
export const DEFAULT_OPENCODE_VERSION = '1.18.30+harness.7c479429'
...
export const DEFAULT_OMO_SLIM_VERSION = '2.2.18'
export const DEFAULT_OMO_PROVIDERS = ''
export const DEFAULT_SYSTEMATIC_VERSION = '3.18.2'
