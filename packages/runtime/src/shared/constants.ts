...
export const DEFAULT_OPENCODE_VERSION = '1.18.18+harness.39b7b193'
...
export const DEFAULT_OMO_SLIM_VERSION = '2.2.13'
export const DEFAULT_OMO_PROVIDERS = ''
export const DEFAULT_SYSTEMATIC_VERSION = '3.12.4'
