...
export const DEFAULT_OPENCODE_VERSION = '1.18.21+harness.22dee0ee'
...
export const DEFAULT_OMO_SLIM_VERSION = '2.2.15'
export const DEFAULT_OMO_PROVIDERS = ''
export const DEFAULT_SYSTEMATIC_VERSION = '3.15.0'
