...
- [sse-output-streaming-terminal-drain-2026-06-21.md](sse-output-streaming-terminal-drain-2026-06-21.md) — the **observation counterpart's** output/completeness layer: how a launched run's ordered output reaches the operator completely (terminal-as-graceful-drain, ordering, replay cache, coalescing). PR #974.
